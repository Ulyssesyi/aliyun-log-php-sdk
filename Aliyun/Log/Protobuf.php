 ...
 */
class Protobuf {
    public const TYPE_DOUBLE = 1;   // double, exactly eight bytes on the wire.
    public const TYPE_FLOAT = 2;   // float, exactly four bytes on the wire.
    public const TYPE_INT64 = 3;   // int64, varint on the wire.  Negative numbers
    // take 10 bytes.  Use TYPE_SINT64 if negative
    // values are likely.
    public const TYPE_UINT64 = 4;   // uint64, varint on the wire.
    public const TYPE_INT32 = 5;   // int32, varint on the wire.  Negative numbers
    // take 10 bytes.  Use TYPE_SINT32 if negative
    // values are likely.
    public const TYPE_FIXED64 = 6;   // uint64, exactly eight bytes on the wire.
    public const TYPE_FIXED32 = 7;   // uint32, exactly four bytes on the wire.
    public const TYPE_BOOL = 8;   // bool, varint on the wire.
    public const TYPE_STRING = 9;   // UTF-8 text.
    public const TYPE_GROUP = 10;  // Tag-delimited message.  Deprecated.
    public const TYPE_MESSAGE = 11;  // Length-delimited message.

    public const TYPE_BYTES = 12;  // Arbitrary byte array.
    public const TYPE_UINT32 = 13;  // uint32, varint on the wire
    public const TYPE_ENUM = 14;  // Enum, varint on the wire
    public const TYPE_SFIXED32 = 15;  // int32, exactly four bytes on the wire
    public const TYPE_SFIXED64 = 16;  // int64, exactly eight bytes on the wire
    public const TYPE_SINT32 = 17;  // int32, ZigZag-encoded varint on the wire
    public const TYPE_SINT64 = 18;  // int64, ZigZag-encoded varint on the wire
